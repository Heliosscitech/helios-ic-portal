      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex-1">
          <select 
            ...
            className="w-full p-3 border border-red-200 rounded-xl text-[13px] outline-none bg-white font-bold text-text-2 appearance-none shadow-sm cursor-pointer"
            style={{ 
        ...
        <div className="flex gap-2">
          <button 
            onClick={onCancel}
            className="px-6 py-2.5 bg-white border border-border rounded-xl text-[13px] font-bold text-text hover:bg-surface-2 transition-all active:scale-95"
          >
            Vazgeç
          </button>
          <button 
            onClick={onSave}
            className="px-6 py-2.5 bg-[#1a1a19] text-white rounded-xl text-[13px] font-bold shadow-lg hover:bg-black transition-all active:scale-95"
          >
            Kaydet
          </button>
        </div>
